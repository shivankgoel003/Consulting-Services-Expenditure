...
We investigated the trend between the expenditure and budget type, the findings were summarized into a table, where maximum, minimum, average and total expenditure values were observed in relation to the Operating and the Capital budget types. The summarized table can be seen in @tbl_summary_17_21.
...
We can see in the summary table @tbl_summary_17_21, that the consulting expenditure cost with capital budget type has always been relatively higher than the operational budget type. A capital budget is the system which is used by businesses to decide on long-term upgrades and replacements where as operational budget is a company's financial plan for its day-to-day expenses. 
